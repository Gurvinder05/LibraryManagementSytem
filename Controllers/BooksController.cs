...
namespace LibraryManagementSytem.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(LabiraryDbContext context)
        {
            _context = context;
        }
        ...
        {
            var labiraryDbContext = _context.Books.Include(b => b.Publisher);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,PublisherId,Author")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
